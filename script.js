...
const apiUrl = `https://weatherapp-sintiya.vercel.app/${endPoint}?city=${city}`;
  try {
...
function updateForecastItems(weatherData) {
  ...
  const forecastItem = `
    <div class="forecast-item">
      ...
      <img src="assets/icons/${getWeaatherIcon(id)}" class="forecast-item-img">
